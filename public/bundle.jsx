...
/***/ function(module, exports, __webpack_require__) {
	...
	'use strict';Object.defineProperty(exports,"__esModule",{value:true});exports.fetchTodos=exports.toggleTodo=exports.addTodo=undefined;var _promise=__webpack_require__(17);var _promise2=_interopRequireDefault(_promise);var _shortid=__webpack_require__(7);var _index=__webpack_require__(218);var _fakeDB=__webpack_require__(16);var api=_interopRequireWildcard(_fakeDB);function _interopRequireWildcard(obj){if(obj&&obj.__esModule){return obj;}else{var newObj={};if(obj!=null){for(var key in obj){if(Object.prototype.hasOwnProperty.call(obj,key))newObj[key]=obj[key];}}newObj.default=obj;return newObj;}}function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}var requestTodos=function requestTodos(filter){return{type:'REQUEST_TODOS',filter:filter};};var addTodo=exports.addTodo=function addTodo(name){return{type:'ADD_TODO',id:(0,_shortid.generate)(),name:name};};var toggleTodo=exports.toggleTodo=function toggleTodo(id){return{type:'TOGGLE_TODO',id:id};};var receiveTodos=function receiveTodos(filter,response){return{type:'RECEIVE_TODOS',filter:filter,response:response};};var fetchTodos=exports.fetchTodos=function fetchTodos(filter){return function(dispatch,getState){var state=getState();if((0,_index.getIsFetching)(state,filter)){return _promise2.default.resolve();}dispatch(requestTodos(filter));return api.fetchTodos(filter).then(function(response){return dispatch(receiveTodos(filter,response));});};};
