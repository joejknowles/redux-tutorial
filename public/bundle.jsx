...
/***/ function(module, exports, __webpack_require__) {
	...
	var _FilterTodos = __webpack_require__(109);
	...
	var TodoApp = function TodoApp() {
	  return React.createElement(
	    ...
	    React.createElement(_FilterTodos2.default, null),
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = createStore(todoApp);
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(27)(IteratorPrototype, __webpack_require__(51)('iterator'), function(){ return this; });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _todoItem = __webpack_require__(112);
	...
	var List = function List(_ref) {
	  ...
	  return React.createElement(
	    ...
	    todos.map(function (todoItem) {
	      return React.createElement(_todoItem2.default, (0, _extends3.default)({ key: todoItem.id
	      }, todoItem, {
	        onClick: function onClick() {
	          return onTodoClick(todoItem.id);
	        } }));
	    })
	  );
	};

	exports.default = connect(mapStateToProps, mapDispatchToProps)(List);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _InputText = __webpack_require__(108);
	    ...
	    value: function render() {
	      ...
	      return React.createElement(
	        ...
	        { onAddTodo: function onAddTodo(name) {
	            return store.dispatch({ type: 'ADD_TODO', id: ++nextTodoId, name: name });
	          } },
	        'Add Todo'
	      );
	    }
	...
	module.exports = {
	  set: Object.setPrototypeOf || ('__proto__' in {} ? // eslint-disable-line
	    function(test, buggy, set){
	      try {
	        set = __webpack_require__(25)(Function.call, __webpack_require__(96).f(Object.prototype, '__proto__').set, 2);
	        set(test, []);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _FilterLink = __webpack_require__(110);

	var _FilterLink2 = _interopRequireDefault(_FilterLink);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	function FilterTodos(_ref) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var FilterLink = function (_Component) {
	  (0, _inherits3.default)(FilterLink, _Component);

	  function FilterLink() {
	    (0, _classCallCheck3.default)(this, FilterLink);
	    return (0, _possibleConstructorReturn3.default)(this, (0, _getPrototypeOf2.default)(FilterLink).apply(this, arguments));
	  }

	  (0, _createClass3.default)(FilterLink, [{
	    key: 'componentDidMount',
	    value: function componentDidMount() {
	      var _this2 = this;
...
/***/ function(module, exports) {
	...
	function TodoItem(_ref) {
	  ...
	  var tick = completed ? React.createElement(
	    "span",
	    null,
	    " ✓"
	  ) : null;
