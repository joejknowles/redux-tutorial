...
/***/ function(module, exports, __webpack_require__) {
	...
	'use strict';Object.defineProperty(exports,"__esModule",{value:true});exports.fetchTodos=exports.toggleTodo=exports.addTodo=undefined;var _promise=__webpack_require__(17);var _promise2=_interopRequireDefault(_promise);var _shortid=__webpack_require__(7);var _index=__webpack_require__(218);var _fakeDB=__webpack_require__(16);var api=_interopRequireWildcard(_fakeDB);function _interopRequireWildcard(obj){if(obj&&obj.__esModule){return obj;}else{var newObj={};if(obj!=null){for(var key in obj){if(Object.prototype.hasOwnProperty.call(obj,key))newObj[key]=obj[key];}}newObj.default=obj;return newObj;}}function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}var addTodo=exports.addTodo=function addTodo(name){return{type:'ADD_TODO',id:(0,_shortid.generate)(),name:name};};var toggleTodo=exports.toggleTodo=function toggleTodo(id){return{type:'TOGGLE_TODO',id:id};};var fetchTodos=exports.fetchTodos=function fetchTodos(filter){return function(dispatch,getState){if((0,_index.getIsFetching)(getState(),filter)){return _promise2.default.resolve();}dispatch({type:'FETCH_TODOS_REQUEST',filter:filter});return api.fetchTodos(filter).then(function(response){dispatch({type:'FETCH_TODOS_SUCCESS',filter:filter,response:response});},function(error){dispatch({type:'FETCH_TODOS_ERROR',filter:filter,message:error.message||'that ain\'t right!'});});};};
